...
_line.material=object.material;if(object.material.vertexColors===THREE.VertexColors){_line.vertexColors[0].copy(object.geometry.colors[v]);_line.vertexColors[1].copy(object.geometry.colors[v-1])}_renderData.elements.push(_line)}}}}}else{if(object instanceof THREE.Sprite){_vector4.set(_modelMatrix.elements[12],_modelMatrix.elements[13],_modelMatrix.elements[14],1);_vector4.applyMatrix4(_viewProjectionMatrix);var invW=1/_vector4.w;_vector4.z*=invW;if(_vector4.z>=-1&&_vector4.z<=1){_sprite=getNextSpriteInPool();_sprite.id=object.id;_sprite.x=_vector4.x*invW;_sprite.y=_vector4.y*invW;_sprite.z=_vector4.z;_sprite.renderOrder=object.renderOrder;_sprite.object=object;_sprite.rotation=object.rotation;_sprite.scale.x=object.scale.x*Math.abs(_sprite.x-(_vector4.x+camera.projectionMatrix.elements[0])/(_vector4.w+camera.projectionMatrix.elements[12]));_sprite.scale.y=object.scale.y*Math.abs(_sprite.y-(_vector4.y+camera.projectionMatrix.elements[5])/(_vector4.w+camera.projectionMatrix.elements[13]));_sprite.material=object.material;_renderData.elements.push(_sprite)}}}}}if(sortElements===true){_renderData.elements.sort(painterSort)}return _renderData};function getNextObjectInPool(){if(_objectCount===_objectPoolLength){var object=new THREE.RenderableObject();_objectPool.push(object);_objectPoolLength++;_objectCount++;return object}return _objectPool[_objectCount++]}function getNextVertexInPool(){if(_vertexCount===_vertexPoolLength){var vertex=new THREE.RenderableVertex();_vertexPool.push(vertex);_vertexPoolLength++;_vertexCount++;return vertex}return _vertexPool[_vertexCount++]}function getNextFaceInPool(){if(_faceCount===_facePoolLength){var face=new THREE.RenderableFace();_facePool.push(face);_facePoolLength++;_faceCount++;return face}return _facePool[_faceCount++]}function getNextLineInPool(){if(_lineCount===_linePoolLength){var ,sctPoolLen==_ar ,sctPoolL,inePoolisctPoolL,inePoolisctPoolL,inePoolisctPoolL,inePoolsctPisc,inePoolisctPoolLXne(indices[i],ind_face.olL,inePoolsctPisl{ex.y-vertxxPool.pus}+mePoolsctPisc,ioar n=0,nl=Pis,L,inPoolL,[_f-nl=P,inPoolL,[_f-nl=Pce.ect:setObject,plhect:setObject,plhect(vetOb)ect=plhs[i+2]isctPoolLXne(indices[i],ind_face.olL,inePoolsctPi_face.olL,inruvs[i+1])}}if(geop{rials.matxPoolLengt}+mXne(indices[i]lg;(ctPisc,inePoolisctPoolLXne(indicesndices[ct.geometry.vr,es[ice3ndicesnw(,es[ice3nddicesnw(==false)olisctPoolLXne.elemctPoolLXne.elemctPoolLXneu<olLengthLXnei(v<zolisctPoolLXne.ellces[ct.geometry.vr;olisct1)shVertngth){vareomhVertn;olngtVerl(x,y,z){nz1es[ct,,x,yerlgnz1es[ct,,x,yer{nz1lgnrl(x,y,z){nz1es[cXpplyMatrix4(_modeices[is[ct,,x,yer{nz1lgl{nue}if(sixct,plhect}+mx,yer{nz1lgnrllhtexUvs[f]0ue}if(sixct,plhect}+mx,yer{nz1lgnrllhtexUvs[f]0uength;i<l;i+=3fVerl(x,y,z){nz1eslces[ct.geometry.rces[ct.geom(creenrhneof .rcess[ct.falss[f]0ue}if(sixct,plhertex()esixcositsixct,tex;=P,inPoolt}+mx,y]0ux3(length;i<l;iss[f]0ue}s[f]0ue}s[f]0ue}s[f] :ixcositsixct,tex;=P,inPoolt}+mx,cositsixr.posit]0ue}if(sixct,plherte}if(sixy];var ofx;=P,inPooltert)